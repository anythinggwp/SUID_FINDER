...
declare -A dbus_daemon_launch_helper_desc=(
  ...
  ["Штатное использование"]="создание частных D-Bus-шинов для приложений."
  ["Риск при компрометации"]="возможность перехвата или подмены межпроцессного взаимодействия."
)

declare -A sumac_desc=(
  ["Назначение"]="дистрибутивно-специфичный системный компонент (обычно PAM/аутентификация)."
  ["Штатное использование"]="вспомогательные функции безопасности системы."
  ["Риск при компрометации"]="потенциальное получение привилегий или обход механизмов аутентификации."
)
